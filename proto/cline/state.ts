...
export interface ApiConfiguration {
  ...
  planModeHuaweiCloudMaasModelInfo?: string | undefined;
  ...
  actModeHuaweiCloudMaasModelInfo?: string | undefined;
...
export const ApiConfiguration: MessageFns<ApiConfiguration> = {
  encode(message: ApiConfiguration, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.planModeVercelAiGatewayModelInfo !== undefined) {
      writer.uint32(986).string(message.planModeVercelAiGatewayModelInfo);
    }
    ...
    if (message.actModeVercelAiGatewayModelInfo !== undefined) {
      writer.uint32(1786).string(message.actModeVercelAiGatewayModelInfo);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 123: {
          ...
          message.planModeVercelAiGatewayModelInfo = reader.string();
          continue;
        }
        case 200: {
          if (tag !== 1602) {
        ...
        case 223: {
          ...
          message.actModeVercelAiGatewayModelInfo = reader.string();
          continue;
        }
        case 300: {
          if (tag !== 2402) {
  ...
  fromJSON(object: any): ApiConfiguration {
    return {
      ...
      planModeVercelAiGatewayModelInfo: isSet(object.planModeVercelAiGatewayModelInfo)
        ? globalThis.String(object.planModeVercelAiGatewayModelInfo)
        : undefined,
      ...
      actModeVercelAiGatewayModelInfo: isSet(object.actModeVercelAiGatewayModelInfo)
        ? globalThis.String(object.actModeVercelAiGatewayModelInfo)
        : undefined,
  ...
  toJSON(message: ApiConfiguration): unknown {
    ...
    if (message.planModeVercelAiGatewayModelInfo !== undefined) {
      obj.planModeVercelAiGatewayModelInfo = message.planModeVercelAiGatewayModelInfo;
    }
    if (message.actModeApiProvider !== undefined) {
    ...
    if (message.actModeVercelAiGatewayModelInfo !== undefined) {
      obj.actModeVercelAiGatewayModelInfo = message.actModeVercelAiGatewayModelInfo;
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ApiConfiguration>, I>>(object: I): ApiConfiguration {
    ...
    message.planModeVercelAiGatewayModelInfo = object.planModeVercelAiGatewayModelInfo ?? undefined;
    ...
    message.actModeVercelAiGatewayModelInfo = object.actModeVercelAiGatewayModelInfo ?? undefined;
