...
export const GetUriSchemeResponse: MessageFns<GetUriSchemeResponse> = {
  ...
  create(base?: DeepPartial<GetUriSchemeResponse>): GetUriSchemeResponse {
    return GetUriSchemeResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetUriSchemeResponse>): GetUriSchemeResponse {
    const message = createBaseGetUriSchemeResponse();
...
export interface EnvServiceImplementation<CallContextExt = {}> {
  ...
  getUriScheme(
    request: EmptyRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<GetUriSchemeResponse>>;
  /**
   * Returns the telemetry settings of the host environment. This may return UNSUPPORTED
   * if the host does not specify telemetry settings for the plugin.
   */
